...
export const TIER_THRESHOLDS: TierThreshold[] = [
  {
    tier: NetworkTier.INDIVIDUAL,
    minUnits: 1,
    radiusKm: 0,
    maxLatencyMs: 1,
    bandwidthGbps: 10,
    name: "Individual Node",
    description: "Single Ghost Node",
  },
  {
    tier: NetworkTier.LOCAL_CLUSTER,
    minUnits: 50,
    radiusKm: 50,
    maxLatencyMs: 10,
    bandwidthGbps: 1,
    name: "Local Cluster",
    description: "City-wide cluster",
  },
  {
    tier: NetworkTier.METRO,
    minUnits: 250,
    radiusKm: 200,
    maxLatencyMs: 50,
    bandwidthGbps: 10,
    name: "Metro Network",
    description: "Greater metropolitan",
  },
  {
    ...
    description: "State/national",
  },
  {
    tier: NetworkTier.CONTINENTAL,
    minUnits: 50000,
    radiusKm: 5000,
    maxLatencyMs: 200,
    bandwidthGbps: 1000,
    name: "Continental Backbone",
    description: "Entire continent",
  },
  {
    tier: NetworkTier.GLOBAL,
    minUnits: 200000,
    radiusKm: 20000,
    maxLatencyMs: 500,
    bandwidthGbps: 10000,
