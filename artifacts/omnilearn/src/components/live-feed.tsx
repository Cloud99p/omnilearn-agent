...
const EVENT_TEMPLATES = [
  ...
  },
  {
    ...
    texts: [
      () =>
        `Performance scan — retrieval precision ${(Math.random() * 0.15 + 0.8).toFixed(3)}`,
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  borderColor: ev.moduleColor + "40",
                  backgroundColor: ev.moduleColor + "10",
                }}
              >
                {ev.module}
              </div>
              ...
              <span
                className={`font-mono text-[10px] shrink-0 ${ev.tagColor} opacity-70`}
              >
                {ev.tag}
              </span>
            </motion.div>
