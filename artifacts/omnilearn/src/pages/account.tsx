      ...
      <div className="flex items-center gap-5 p-5 rounded-xl bg-card border border-border/40">
        ...
        <div>
          ...
          {profile?.githubUsername && (
            ...
            >
              <Github className="w-3 h-3" />@{profile.githubUsername}
        ...
        <div className="space-y-4">
          ...
          <div className="pt-2">
            <div className="p-4 rounded-lg bg-primary/5 border border-primary/20 font-mono text-xs text-muted-foreground">
              Profile information is synced from your connected accounts. To
              update your name or email, edit them in the connected account
              provider.
            </div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="p-4 rounded-lg bg-card border border-border/40 font-mono text-xs text-muted-foreground">
            ...
            <div className="mt-3 pt-3 border-t border-border/20">
              Connect GitHub to browse, create, fork, and share repositories
              directly from OmniLearn. Connect Google for quick sign-in across
              devices.
            </div>
          </div>
        </div>
      ...
      {activeTab === "security" && (
        <div className="space-y-4">
          ...
          <div className="p-4 rounded-lg bg-card border border-border/40 font-mono text-xs text-muted-foreground space-y-1">
            ...
            <SecItem
              text="Connect multiple providers for account recovery"
              done={
                (profile?.hasGitHub ? 1 : 0) + (profile?.hasGoogle ? 1 : 0) >= 2
              }
            />
            <SecItem
              text="Use a verified primary email address"
              done={!!profile?.email}
            />
