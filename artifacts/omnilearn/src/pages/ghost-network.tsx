    ...
    <div className="min-h-screen p-6 md:p-10 max-w-4xl mx-auto">
      ...
      {status && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
          {[
            { label: "Total nodes", value: status.total, icon: Server, color: "text-foreground" },
            { label: "Online", value: status.online, icon: CheckCircle2, color: "text-emerald-400" },
            { label: "Offline", value: status.offline, icon: XCircle, color: "text-red-400" },
            { label: "Tasks processed", value: status.totalTasksProcessed, icon: Zap, color: "text-primary" },
