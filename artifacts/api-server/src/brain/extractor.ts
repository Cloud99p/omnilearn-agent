...
export function normalizePDFText(text: string): string {
  ...
  const commonSplits: Array<[RegExp, string]> = [
    ...
    [/drill\s+ing/gi, 'drilling'],
    [/mill\s+ing/gi, 'milling'],
    [/turn\s+ing/gi, 'turning'],
    [/grind\s+ing/gi, 'grinding'],
    ...
    [/loca\s+tion/gi, 'location'],
    [/sta\s+tion/gi, 'station'],
    ...
    // Additional patterns for workshop/engineering content
    [/worksho\s+p/gi, 'workshop'],
    [/process\s+es/gi, 'processes'],
    [/layout\s+s/gi, 'layouts'],
    [/tool\s+s/gi, 'tools'],
    [/machine\s+s/gi, 'machines'],
    [/part\s+s/gi, 'parts'],
    [/component\s+s/gi, 'components'],
    [/material\s+s/gi, 'materials'],
    [/operation\s+s/gi, 'operations'],
    [/techniqu\s+es/gi, 'techniques'],
    [/method\s+s/gi, 'methods'],
    [/system\s+s/gi, 'systems'],
    [/design\s+s/gi, 'designs'],
    [/specification\s+s/gi, 'specifications'],
    [/measurement\s+s/gi, 'measurements'],
    [/dimension\s+s/gi, 'dimensions'],
    [/tolerance\s+s/gi, 'tolerances'],
    [/surface\s+s/gi, 'surfaces'],
